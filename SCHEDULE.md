...
-   Each data showcase, model introduction should come with a simple graphviz diagram rendered using oxdraw. LR is preferred. The diagram should highlight key flow and remove unimportant subtles.
